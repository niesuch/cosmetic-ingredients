...
public class ReportErrorIngredientActivity extends Activity {
	String pid;
	JSONParser jsonParser = new JSONParser();
	EditText errorDesc;

	private static String url_php = "http://lickn.cba.pl/panel_administracyjny/android-connect/request_modification_ingredient.php";

	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.report_error_ingredient);
	...
	class SendRequest extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			params.add(new BasicNameValuePair("id_ingredient", pid));
